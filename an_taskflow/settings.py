"""
Django settings for an_taskflow project.
...
SECRET_KEY = 'django-insecure-*tr!m-ebg$(7e$z)0eh+4$l!dbal6@lt5@0ga^9dog)(drex-u'
...
WSGI_APPLICATION = 'an_taskflow.wsgi.application'
...
# 静态文件收集目录（collectstatic 目标目录）
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# 使用 WhiteNoise 存储后端（支持压缩和缓存）
...
#     "https://coco.j1.sale",  # 你的前端域名
#     # 如需多个源，依次添加
#     # "https://xxx.j1.sale",
# ]
# CORS_ALLOW_CREDENTIALS = True  # 允许携带Cookie/认证信息