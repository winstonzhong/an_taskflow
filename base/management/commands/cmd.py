...
#
# async def django_main_business(每轮间隔秒数=1, **kwargs):
...
#             if forward_data.get('type') == 'group_switch':
#
#                 selected_list = forward_data.get('selected')
#                 unselected_list = forward_data.get('unselected')
#                 print('selected_list', selected_list)
#                 print('unselected_list', unselected_list)
#                 update_func = sync_to_async(定时任务.更新技能激活状态)
#                 if selected_list:
#                     await update_func(selected_list, True)
#
#                     ret_data = {
...
#                         'timestamp': time.time(),
#                     }
#                     await shared_data.django_to_ws_queue.put(ret_data)
#
#                 if unselected_list:
#                     await update_func(unselected_list, False)
#
#                     ret_data = {
#                         'type': 'group_switch_result',
...
#         # ====================== 任务3：执行真实业务 ======================
#
#         task_func = sync_to_async(定时任务.执行一轮定时任务)
#         await task_func(**kwargs)
#         await asyncio.sleep(每轮间隔秒数)
#
# async def main(每轮间隔秒数=1, **kwargs):
...
#     business_task = asyncio.create_task(django_main_business(每轮间隔秒数=每轮间隔秒数, **kwargs))
#
#     # ====================== 新增：延迟打开浏览器窗口 ======================
